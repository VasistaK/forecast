...
<div 
className="max-[700px]:mt-[118px] max-[720px]:mt-[283px] max-[920px]:mt-[130px] max-[740px]:mt-[100px] max-[940px]:mt-[150px] max-[640px]:grid flex-wrap flex text-center p-2 mt-[380px]  justify-around border-2 border-gray-400 items-center mx-2 max-sm:grid grid-cols-2 max-sm:mt-[100px] max-sm:gap-y-[50px] ">
